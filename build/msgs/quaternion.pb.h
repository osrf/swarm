...
void IGNITION_MSGS_VISIBLE protobuf_AddDesc_quaternion_2eproto();
...
class IGNITION_MSGS_VISIBLE Quaternion : public ::google::protobuf::Message {
 public:
  Quaternion();
  virtual ~Quaternion();
  ...
  // @@protoc_insertion_point(class_scope:swarm.msgs.Quaternion)
 private:
  ...
  double z_;
  double w_;
  friend void IGNITION_MSGS_VISIBLE protobuf_AddDesc_quaternion_2eproto();
...
inline double Quaternion::x() const {
  // @@protoc_insertion_point(field_get:swarm.msgs.Quaternion.x)
  return x_;
}
inline void Quaternion::set_x(double value) {
  set_has_x();
  x_ = value;
  // @@protoc_insertion_point(field_set:swarm.msgs.Quaternion.x)
}
...
inline double Quaternion::y() const {
  // @@protoc_insertion_point(field_get:swarm.msgs.Quaternion.y)
  return y_;
}
inline void Quaternion::set_y(double value) {
  set_has_y();
  y_ = value;
  // @@protoc_insertion_point(field_set:swarm.msgs.Quaternion.y)
}
...
inline double Quaternion::z() const {
  // @@protoc_insertion_point(field_get:swarm.msgs.Quaternion.z)
  return z_;
}
inline void Quaternion::set_z(double value) {
  set_has_z();
  z_ = value;
  // @@protoc_insertion_point(field_set:swarm.msgs.Quaternion.z)
}
...
inline double Quaternion::w() const {
  // @@protoc_insertion_point(field_get:swarm.msgs.Quaternion.w)
  return w_;
}
inline void Quaternion::set_w(double value) {
  set_has_w();
  w_ = value;
  // @@protoc_insertion_point(field_set:swarm.msgs.Quaternion.w)
}


typedef std::shared_ptr<swarm::msgs::Quaternion> QuaternionPtr;
...
typedef const std::shared_ptr<swarm::msgs::Quaternion const> ConstQuaternionPtr;
