...
Gps::Gps()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:swarm.msgs.Gps)
}
...
Gps::Gps(const Gps& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:swarm.msgs.Gps)
}
...
Gps::~Gps() {
  // @@protoc_insertion_point(destructor:swarm.msgs.Gps)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:swarm.msgs.Gps)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:swarm.msgs.Gps)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:swarm.msgs.Gps)
  return false;
#undef DO_
}
...
void Gps::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:swarm.msgs.Gps)
  // required double latitude = 1;
  if (has_latitude()) {
  ...
  // @@protoc_insertion_point(serialize_end:swarm.msgs.Gps)
}

::google::protobuf::uint8* Gps::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:swarm.msgs.Gps)
  // required double latitude = 1;
  if (has_latitude()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:swarm.msgs.Gps)
  return target;
}
